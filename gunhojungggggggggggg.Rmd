...
library(dplyr)
# Load in dataset
dat <- read_csv("https://raw.githubusercontent.com/gunhojung/315_final_project/master/new%20countries%202.csv")
...
shinyApp(
  ...
  server = function(input, output) {
    output$sector_plot <- renderPlot({
      sector_p <- ggplot(subset(dat, region %in% c(input$which_region))) +
...
#  Question: Does all graph have to be interactive?
